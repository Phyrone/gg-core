...
private typealias BukkitSound = org.bukkit.Sound
/*
 ...
 * minecraft versions.
 */
enum class UniversalSound(vararg versionDependentNames: String) {
    ...
    private val versionDependentNames: Array<out String> = versionDependentNames
     ...
     */
    val bukkitSound by lazy(LazyThreadSafetyMode.PUBLICATION) {
        for (name in versionDependentNames) {
            try {
                return@lazy BukkitSound.valueOf(name)
